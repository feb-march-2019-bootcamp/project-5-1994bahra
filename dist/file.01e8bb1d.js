...
},{"process":"../../../AppData/Roaming/npm/node_modules/parcel/node_modules/process/browser.js"}],"file.js":[function(require,module,exports) {
"use strict";
...
(0, _jquery.default)(document).ready(function () {
  ...
  function chColor() {
    ...
    (0, _jquery.default)("body").css("transition", "background-color 2s ease");
    (0, _jquery.default)("body").css("background-color", colors[colorNum]);
    (0, _jquery.default)(".text").css("transition", "color 2s ease");
    (0, _jquery.default)(".text").css("color", colors[colorNum]);
    (0, _jquery.default)(".button").css("transition", "background-color 2s ease");
    (0, _jquery.default)(".button").css("background-color", colors[colorNum]);
  } // get a new quote


  function getQuote() {
    //   min=0 , max=quotes.length
    var number = getRandom(0, quotes.length);
    (0, _jquery.default)("#quotetext").html(quotes[number].quote);
    (0, _jquery.default)("#author").html(quotes[number].author);
  }

  getQuote();
  (0, _jquery.default)("#new-quote").on("click", function () {
    getQuote();
    chColor();
    colorNum++;
  });
  var randomQuote = getRandom();
  var currentQuote = randomQuote.quote;
  var currentAuthor = randomQuote.author;
  (0, _jquery.default)("#tweet-quote").on("click", function () {
    window.open(twitterURL + '"' + currentQuote + '"_ ' + currentAuthor);
  });
  (0, _jquery.default)("#tumblr-quote").on("click", function () {
...
},{}]},{},["../../../AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js","file.js"], null)
//# sourceMappingURL=/file.01e8bb1d.map